...
export default function AboutUs() {
  ...
  // 🟢 THE FIX: Auto-format the brand name (e.g., "NAIJA" + "HOMEMADE" -> "Naijahomemade")
  ...
  return (
    <div style={{ 
      ...
      <section>
        <h1 style={headerStyle}>About {brandName}</h1>
        <p style={textBlockStyle}>
          Welcome to <strong>{brandName}</strong>, where passion meets privilege, and fandom reaches new heights! We're not just a platform; we're your exclusive gateway to an immersive world of entertainment and connection. Here, being a fan means more – it means having the key to unlock doors others can only dream of opening.
        </p>
        <p style={textBlockStyle}>
          Our {brandName} experience is designed for those who crave more than just the ordinary. It's a journey that begins with exploration, as you navigate through a curated universe of exclusive content and behind-the-scenes wonders. From unreleased tracks to intimate moments with your favorite creators, we ensure you're not just a spectator but an integral part of the magic.
        </p>
      </section>
      ...
      <section>
        ...
        <p style={textBlockStyle}>
          Unlike other platforms, <strong>{brandName}</strong> is specifically focused on empowering African creators. We understand the unique cultural context, challenges, and opportunities in the African market.
        </p>
      ...
      <section>
        ...
        <p style={textBlockStyle}>
          We envision <strong>{brandName}</strong> becoming the leading platform for African creators, driving economic growth within the continent's digital economy and showcasing incredible talent to the world. We are continuously developing new features and expanding our resources to further empower our community.
        </p>
      </section>
      ...
      <footer style={{ marginTop: "50px", padding: "20px 0", borderTop: "1px solid #333", textAlign: "center", fontSize: "13px" }}>
        ...
        <p>© {new Date().getFullYear()} {brandName}. All content is for personal, non-commercial use only.</p>
      </footer>
    </div>
  );
}