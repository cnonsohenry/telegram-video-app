    ...
    <div style={loginContainerStyle}>
      ...
      <div style={footerBox}>
        ...
        <p style={{ fontSize: "14px", color: "#fff", margin: 0 }}>
          ...
          <span onClick={() => { setIsRegistering(!isRegistering); setError(""); }} style={{ color: "var(--primary-color)", fontWeight: "700", cursor: "pointer" }}>
...
const errorBannerStyle = { background: "rgba(255, 59, 48, 0.1)", color: "var(--primary-color)", padding: "10px", borderRadius: "8px", marginBottom: "15px", fontSize: "13px", textAlign: "center", width: "100%", border: "1px solid rgba(255, 59, 48, 0.2)" };
...
const roundedInputStyle = { width: "100%", background: "var(--bg-color)", border: "1px solid #333", borderRadius: "30px", padding: "12px 20px", color: "#fff", fontSize: "15px", outline: "none" };
const loginButtonStyle = { background: "var(--primary-color)", color: "#fff", border: "none", borderRadius: "30px", padding: "14px", fontSize: "15px", fontWeight: "700", marginTop: "10px", cursor: "pointer" };
