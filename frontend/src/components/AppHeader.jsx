...
const mobileHeaderStyle = { position: "sticky", top: 0, zIndex: 1000, padding: "12px 15px", display: "flex", alignItems: "center", justifyContent: "space-between", background: "var(--bg-color)", borderBottom: "2px solid var(--border-color)" };
